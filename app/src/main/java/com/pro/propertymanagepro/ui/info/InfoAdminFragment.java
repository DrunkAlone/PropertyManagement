...
public class InfoAdminFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.fragment_info_admin, container, false);
        ...
        iv_update.setItemClickListener(new ItemView.itemClickListener() {
            ...
            public void itemClick(String text) {
                Intent intent = new Intent(InfoAdminFragment.this.getActivity(), InfoActivity.class);
        ...
        iv_moments.setItemClickListener(new ItemView.itemClickListener() {
            ...
            public void itemClick(String text) {
                ...
                if(list.size() == 0){
                    ...
                    Intent intent = new Intent(InfoAdminFragment.this.getActivity(), MyMomentActivity.class);
                    intent.putExtra("username", username);
                    startActivity(intent);
                }
            }
        ...
        iv_settings.setItemClickListener(new ItemView.itemClickListener() {
            @Override
            public void itemClick(String text) {
                Intent intent = new Intent(InfoAdminFragment.this.getActivity(), SettingsActivity.class);
                startActivity(intent);
            }
        });
        iv_logout.setItemClickListener(new ItemView.itemClickListener() {
            ...
            public void itemClick(String text) {
                ...
                Intent intent = new Intent(InfoAdminFragment.this.getActivity(), LoginActivity.class);
                startActivity(intent);
            }
        });
        return root;
